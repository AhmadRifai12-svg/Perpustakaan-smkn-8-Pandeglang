<?php
// header_admin.php
// dipanggil oleh semua halaman admin supaya struktur HTML dan navbar konsisten
...
$menuItems = [
    ...
    ['href' => '?halaman=data_buku', 'icon' => 'fas fa-book', 'label' => 'Data Buku', 'active' => 'data_buku'],
    ['href' => '?halaman=data_anggota', 'icon' => 'fas fa-users', 'label' => 'Data Anggota', 'active' => 'data_anggota'],
    ['href' => '?halaman=data_peminjaman', 'icon' => 'fas fa-hand-holding', 'label' => 'Data Peminjaman', 'active' => 'data_peminjaman'],
    ['href' => 'data_pembayaran.php', 'icon' => 'fas fa-money-bill-wave', 'label' => 'Pembayaran', 'active' => 'data_pembayaran'],
];
...
<head>
    ...
    <title><?= isset($pageTitle) ? $pageTitle : 'Admin Perpustakaan SMKN 8 PANDEGLANG'; ?></title>
